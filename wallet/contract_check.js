...
// Replace this with the ABI (Application Binary Interface) of your smart contract
const contractABI = [
	{
		"inputs": [],
...
// Replace this with the user's Ethereum address you want to check
const userAddress = '0x5145a8426EB329D6E9bC7bAd56FC13DA22d49C97';

// Call the isRegistered function
contract.methods.isRegistered(userAddress).call()
  .then((result) => {
    console.log(`Is ${userAddress} registered: ${result}`);
  })
  .catch((error) => {
    console.error('Error calling isRegistered:', error.message);
  });